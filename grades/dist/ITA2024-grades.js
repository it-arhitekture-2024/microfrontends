...
function App() {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
    ...
    newGrade = _useState4[0],
    setNewGrade = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
    ...
    editedGrade = _useState6[0],
    setEditedGrade = _useState6[1];
  var fetchGrades = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default().get('http://localhost:3000/web/grades');
          case 3:
          ...
          case 7:
            ...
            console.error('Error calling Grades service:', _context.t0);
          case 10:
          case "end":
    ...
    return function fetchGrades() {
      return _ref.apply(this, arguments);
    };
  }();
  var addGrade = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var response, addedGrade;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default().post('http://localhost:3000/web/grades', newGrade);
          case 3:
            response = _context2.sent;
            addedGrade = response.data; // Ensure this includes the unique ID from the backend
            setGrades([].concat(_toConsumableArray(grades), [addedGrade]));
            setNewGrade({
              studentId: '',
              professorId: '',
              subjectId: '',
          ...
          case 10:
            ...
            console.error('Error calling Grades service:', _context2.t0);
          case 13:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default().put("http://localhost:3000/web/grades/".concat(editedGrade.id), editedGrade);
          case 3:
            updatedGrades = grades.map(function (grade) {
              if (grade.id === editedGrade.id || grade._id === editedGrade.id) {
                return _objectSpread(_objectSpread({}, grade), editedGrade);
              }
              return grade;
            });
          ...
          case 8:
            ...
            console.error('Error calling Grades service:', _context3.t0);
          case 11:
          case "end":
  ...
  var deleteGrade = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default()["delete"]("http://localhost:3000/web/grades/".concat(id));
          case 3:
            updatedGrades = grades.filter(function (grade) {
              return grade.id !== id && grade._id !== id;
            });
            setGrades(updatedGrades);
            _context4.next = 10;
            break;
          case 7:
            ...
            console.error('Error calling Grades service:', _context4.t0);
          case 10:
          case "end":
    ...
    return function deleteGrade(_x) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h1", null, "Microservice Frontend: Grades"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("section", {
    className: "add-grade"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h2", null, "Add Grade"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: "input-group"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", {
    htmlFor: "studentId"
  }, "Student ID:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
    type: "text",
    id: "studentId",
    placeholder: "Enter student ID",
    value: newGrade.studentId,
    onChange: function onChange(e) {
      return setNewGrade(_objectSpread(_objectSpread({}, newGrade), {}, {
    ...
    htmlFor: "gradeValue"
  }, "Grade:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
    type: "number",
    id: "gradeValue",
    ...
    onClick: addGrade
  }, "Add Grade")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("section", {
    className: "edit-grade"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h2", null, "Edit Grade"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: "input-group"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", {
    htmlFor: "editGradeId"
  }, "Grade ID:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
    type: "text",
    id: "editGradeId",
    placeholder: "Enter grade ID",
    value: editedGrade.id,
    onChange: function onChange(e) {
      return setEditedGrade(_objectSpread(_objectSpread({}, editedGrade), {}, {
        id: e.target.value
      }));
    }
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    onClick: updateGrade
  }, "Update Grade")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("section", {
    className: "grade-list"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h2", null, "Grades:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("ul", {
    className: "grade-list"
  }, grades.map(function (grade) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("li", {
      key: grade.id || grade._id,
      className: "grade-item"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, grade.gradeValue), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("button", {
      className: "delete-button",
      onClick: function onClick() {
        return deleteGrade(grade.id || grade._id);
      }
    }, "Delete"));
  }))));
}
...
//# sourceMappingURL=ITA2024-grades.js.map